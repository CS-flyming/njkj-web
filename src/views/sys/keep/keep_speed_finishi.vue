...
<template>
    <div>
        ...
        <div class="data-control">
            ...
            <Button type="primary" @click="$downloadByForm('keep/finish/down',filter)">导出</Button>
        </div>
...
import { getSpeedFinishi } from "@/actions/depart";
export default {
  ...
  methods: {
    loadData() {
      this.loading = true;
      getSpeedFinishi(this.filter).then(res => {
        this.loading = false;
